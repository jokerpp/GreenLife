...
public class FragmentMeals_old extends BaseFragment implements OnItemClickListener, OnClickListener {
...
//			OrderConfirmActivity.show(getActivity());
	...
	private ListFoodAdapter.OnCountChangedListener onCountChangedListener = new ListFoodAdapter.OnCountChangedListener() {
		...
		public void onCountChanged(List<FoodItem> arrFoodItems, int iCount,
				int totalPrice) {
			FragmentMeals_old.this.iCount = iCount;
			FragmentMeals_old.this.totalPrice = totalPrice;
			tvCount.setText(iCount + "");
			tvBottomLeft.setText(FragmentMeals_old.this.totalPrice +"");
