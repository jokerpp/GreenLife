 ...
 * 
 */
public class FragmentCollectMerchant extends BaseFragment implements OnClickListener, OnItemClickListener {

	private ListView lv;
	private ListMerchantAdapter<MerchantItem> adapter;
	private List<MerchantItem> arrMerchantItems = new ArrayList<MerchantItem>();
	private Task_Post task_Post_getMyCollectionMerchantList;
	...
	private void getMyCollectionMerchantList() {
...
//		每页记录	pageSize		Int	
		...
		Task_Post.clearTask(task_Post_getMyCollectionMerchantList);
		task_Post_getMyCollectionMerchantList = new Task_Post(map, API.API_getMyCollectionMerchantList,
...
//							App.showToast(R.string.api_error_code_6);
		...
		task_Post_getMyCollectionMerchantList.execute();
